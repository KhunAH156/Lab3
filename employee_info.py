...
def get_employees_by_age_range(age_lower_limit, age_upper_limit, employees_data):
    result = []
...
def calculate_average_salary(employees_data):
    total = 0
    average = 0
    ...
    average=total/len(employees_data)

    
    return average

def get_employees_by_dept(department, employees_data):
    result = []
...
def display_main_menu():
    ...
    if option == '1':
        ...
        employee_info = get_employees_by_age_range(age_lower_limit, age_upper_limit,employee_data)
        display_records(employee_info)


    elif option == '4':
        department = input("Name of Department = ")
        employee_info = get_employees_by_dept(department, employee_data)
        display_records(employee_info)
